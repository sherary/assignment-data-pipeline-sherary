...
| `data/processed/automobile_cleaned_data.csv` | 186 | 48 | Processed Data
...
3. Inconsistencies in capitalization on 'make' column.
4. Incorrect data type used for 'num-of-doors' and 'num-of-cylinders'
5. Whitespaces on some values
...
## These are changes that I made regarding the requirements of the assignment.
## Due to my limited knowledge in automotives, I assume that these are what I can do at the moment.
## Though, I'm aware that each columns are a potential features that might be requested by users.